...
function Sidebar() {
    ...
    return (
    <div className='bg-gray-200 h-full w-9/12 absolute'>
      ...
      <main className="grid w-9/12 min-h-screen text-gray-100 place-content-center">
      <section className="p-3 space-y-6 rounded-xl md:grid md:grid-cols-2 md:gap-4 sm:space-y-0">
